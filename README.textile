...
GSD is a ruby gem for working with "Google Storage for Developers":http://code.google.com/apis/storage/. This gem
is based on "moomerman's GStore gem":https://github.com/moomerman/gstore. Core changes include an Object API,
